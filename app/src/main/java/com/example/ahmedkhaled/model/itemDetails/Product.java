...
public class Product implements Serializable {
    ...
    private final static long serialVersionUID = 7531164511307481026L;
     ...
     * @param categoryId
     */
    public Product(Integer id, String name, String title, Integer categoryId, String description, Integer price, Integer discount, String discountType, String currency, Integer inStock, String avatar, Integer priceFinal, String priceFinalText) {
        super();
        this.id = id;
        this.name = name;
        this.title = title;
